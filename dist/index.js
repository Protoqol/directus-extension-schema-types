  ...
  return openBlock(), createBlock(_component_v_list, { nav: "" }, {
    default: withCtx(() => [
      createVNode(_component_v_list_item, {
        ...
        default: withCtx(() => [
          createVNode(_component_v_list_item_icon, null, {
            default: withCtx(() => [
              createVNode(_component_v_icon, { name: "dataset" })
            ]),
            _: 1
            /* STABLE */
          }),
      ...
      (openBlock(true), createElementBlock(
        Fragment,
        null,
        renderList(_ctx.collections, (col) => {
          return openBlock(), createBlock(_component_v_list_item, {
            ...
            default: withCtx(() => [
              createVNode(_component_v_list_item_icon, null, {
                default: withCtx(() => [
                  createVNode(_component_v_icon, { name: "database" })
                ]),
                _: 1
                /* STABLE */
              }),
                  ...
                  default: withCtx(() => [
                    createVNode(
                      ...
                      null,
                      {
                        default: withCtx(() => [
                          createTextVNode(
                            toDisplayString(col.collection),
                            1
                            /* TEXT */
                          )
                        ]),
...
var Navigation = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["render", _sfc_render$4]]);
...
const _hoisted_10 = { class: "type-label" };
          ...
          (openBlock(true), createElementBlock(
            ...
            renderList(_ctx.rows, (row) => {
              return openBlock(), createElementBlock("tr", {
                ...
                createElementVNode("td", _hoisted_9, [
                  createElementVNode(
                    "span",
                    _hoisted_10,
...
var css$3 = "\n.collections-container[data-v-c0bf3f43] {\r\n  width: 100%;\r\n  text-align: left;\n}\n.table-section[data-v-c0bf3f43] {\r\n  width: 100%;\n}\n.v-table[data-v-c0bf3f43] {\r\n  width: 100%;\r\n  border-collapse: separate;\r\n  border-spacing: 0 8px;\n}\n.v-table thead th[data-v-c0bf3f43] {\r\n  padding: 8px 12px;\r\n  text-align: left;\r\n\r\n  color: var(--theme--foreground-accent);\r\n  font-size: 16px;\r\n  font-weight: var(--theme--form--field--label--font-weight);\r\n  font-family: var(--theme--form--field--label--font-family);\n}\n.v-table tbody tr[data-v-c0bf3f43] {\r\n  cursor: pointer;\n}\n.v-table tbody tr[data-v-c0bf3f43]:hover {\r\n  border-color: var(--theme--border-color-accent);\n}\n.v-table td[data-v-c0bf3f43] {\r\n  padding: 16px 12px;\r\n  border-top: var(--theme--border-width) solid var(--theme--border-color-subdued);\r\n  border-bottom: var(--theme--border-width) solid var(--theme--border-color-subdued);\n}\n.v-table td[data-v-c0bf3f43]:first-child {\r\n  border-left: var(--theme--border-width) solid var(--theme--border-color-subdued);\r\n  border-top-left-radius: var(--theme--border-radius);\r\n  border-bottom-left-radius: var(--theme--border-radius);\n}\n.v-table td[data-v-c0bf3f43]:last-child {\r\n  border-right: var(--theme--border-width) solid var(--theme--border-color-subdued);\r\n  border-top-right-radius: var(--theme--border-radius);\r\n  border-bottom-right-radius: var(--theme--border-radius);\n}\n.selection[data-v-c0bf3f43] {\r\n  width: 48px;\r\n  text-align: center;\n}\n.collection-name[data-v-c0bf3f43] {\r\n  display: flex;\r\n  align-items: center;\r\n  gap: 8px;\n}\n.name[data-v-c0bf3f43] {\r\n  font-family: var(--theme--fonts--monospace--font-family);\r\n  font-size: 14px;\r\n  color: var(--theme--foreground);\n}\r\n";
n(css$3,{});
...
function _sfc_render$2(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", _hoisted_1$1, [
    _ctx.collections && _ctx.collections.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_2$1, [
        ...
        createElementVNode("tbody", null, [
          (openBlock(true), createElementBlock(
            ...
            renderList(_ctx.collections, (col) => {
              return openBlock(), createElementBlock("tr", {
                key: col.collection,
                onClick: ($event) => _ctx.$emit("toggle-collection", col.collection)
              }, [
                createElementVNode("td", {
                  class: "selection",
                  onClick: _cache[1] || (_cache[1] = withModifiers(() => {
                  ...
                  createVNode(_component_v_checkbox, {
                    "model-value": _ctx.selectedCollections.includes(col.collection),
                    "onUpdate:modelValue": ($event) => _ctx.$emit("toggle-collection", col.collection)
                  }, null, 8, ["model-value", "onUpdate:modelValue"])
                ]),
...
var Collections = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["render", _sfc_render$2], ["__scopeId", "data-v-c0bf3f43"]]);
...
class PythonGenerator extends BaseGenerator {
  ...
  generateForCollection(collection, fields) {
    ...
    let code = `class ${collectionName}:
`;
    const pythonVersion = this.options.languageVersion ? parseFloat(this.options.languageVersion) : 3.1;
    fields.forEach((row) => {
  ...
  setup(props) {
    ...
    watch([selectedLanguage, tsTypeStyle, languageVersion, () => props.fields, () => props.selectedCollections, () => props.collection], async () => {
      ...
      const mainFields = props.fields.map((f) => ({
        ...f,
        relatedCollection: getRelatedCollection(fieldsStore.fields.find((field) => field.collection === props.collection && field.field === f.field))
      }));
...
var css$1 = "\n.generated-type[data-v-4204ae8a] {\r\n  background-color: var(--background-page);\r\n  border: var(--theme--border-width) solid var(--border-subdued);\r\n  border-radius: var(--theme--border-radius);\r\n  padding: 16px;\r\n  min-height: 400px;\r\n  display: flex;\r\n  flex-direction: column;\n}\n.header[data-v-4204ae8a] {\r\n  display: flex;\r\n  justify-content: space-between;\r\n  align-items: center;\r\n  margin-bottom: 12px;\r\n  border-bottom: var(--theme--border-width) solid var(--border-subdued);\r\n  padding-bottom: 10px;\r\n  flex: 0 0 auto;\n}\n.title[data-v-4204ae8a] {\r\n  font-size: 14px;\r\n  font-weight: 600;\r\n  color: var(--foreground-normal);\n}\n.options[data-v-4204ae8a] {\r\n  display: flex;\r\n  align-items: center;\r\n  gap: 16px;\n}\n.options[data-v-4204ae8a] .v-checkbox {\r\n  margin-top: 0;\n}\n.actions[data-v-4204ae8a] {\r\n  display: flex;\r\n  align-items: center;\r\n  gap: 8px;\n}\n.lang-icon[data-v-4204ae8a] {\r\n  width: 18px;\r\n  height: 18px;\r\n  margin-right: 8px;\r\n  object-fit: contain;\n}\n.content[data-v-4204ae8a] {\r\n  border-radius: var(--theme--border-radius);\r\n  flex: 1 1 auto;\r\n  display: flex;\r\n  flex-direction: column;\r\n  overflow: hidden;\r\n  background-color: var(--background-subdued);\r\n  border: var(--theme--border-width) solid var(--border-subdued);\n}\n.code-container[data-v-4204ae8a] {\r\n  height: 100%;\r\n  position: relative;\r\n  flex: 1;\r\n  display: flex;\r\n  flex-direction: column;\r\n  overflow: hidden;\n}\n.copy-button[data-v-4204ae8a] {\r\n  position: absolute;\r\n  top: 12px;\r\n  right: 12px;\r\n  z-index: 10;\r\n  background-color: var(--background-page, #ffffff) !important;\n}\n.copy-button[data-v-4204ae8a]:hover {\r\n  background-color: var(--background-subdued, #f9fafb) !important;\n}\n.generated-code[data-v-4204ae8a] {\r\n  height: 100%;\r\n  font-family: var(--family-monospace);\r\n  font-weight: 400;\r\n  font-size: 13px;\r\n  line-height: 1.5;\r\n  background-color: #f9fafb !important;\r\n  color: var(--foreground-normal);\r\n  white-space: pre;\r\n  overflow: auto;\r\n  tab-size: 2;\r\n  border-radius: 8px;\n}\n.generated-code[data-v-4204ae8a] code {\r\n  background-color: transparent !important;\n}\r\n";
n(css$1,{});
  ...
  return openBlock(), createElementBlock("div", _hoisted_1, [
    createElementVNode("div", _hoisted_2, [
      ...
      createElementVNode("div", _hoisted_4, [
        ...
        ["php", "java", "python"].includes(_ctx.selectedLanguage) ? (openBlock(), createBlock(_component_v_select, {
          key: 1,
...
var GeneratedType = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render$1], ["__scopeId", "data-v-4204ae8a"]]);
  ...
  setup(props) {
    ...
    watch(collections, (newCols) => {
      if (newCols.length > 0 && selectedCollections.value.length === 0) {
        selectedCollections.value = newCols.map((c) => c.collection);
      }
    }, { immediate: true });
    const rows = computed(() => {
      try {
    ...
    const toggleAllCollections = () => {
      if (selectedCollections.value.length === collections.value.length) {
        ...
        selectedCollections.value = collections.value.map((c) => c.collection);
      }
    };
    return {
      rows,
...
var css = "\n.headline[data-v-6fe7304b] {\n  display: flex;\n  flex-direction: row;\n  justify-content: space-between;\n  align-items: center;\n  column-gap: 12px;\n}\n.headline .feedback[data-v-6fe7304b] {\n  font-weight: 400;\n  color: var(--theme--foreground-subdued);\n}\n.headline .feedback a[data-v-6fe7304b] {\n  color: inherit;\n}\nmain[data-v-6fe7304b] {\n  display: flex;\n  gap: var(--content-padding);\n  padding: var(--content-padding);\n  align-items: flex-start;\n}\nmain[data-v-6fe7304b] > * {\n  flex: 1;\n  min-width: 0;\n}\n";
n(css,{});
...
var ModuleComponent = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-6fe7304b"]]);
